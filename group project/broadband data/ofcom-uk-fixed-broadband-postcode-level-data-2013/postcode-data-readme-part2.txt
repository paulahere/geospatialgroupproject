...
Key to file: ofcom-part2-fixed-broadband-postcode-level-data-2013.csv
...
Note this file lists the postcode details regarding all the postcodes which are from M33 0DW in Manchester to ZE39JZ in the Shetland Isles.  Note that all BT postcodes (Northern Ireland) are also in this second part.
There is a separate file for postcodes in the first half of the alphabet.
